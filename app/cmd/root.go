...
var rootCmd = &cobra.Command{
	Use:   "cursoFullCycle-Arquitetura-Hexagonal",
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.cursoFullCycle-Arquitetura-Hexagonal.yaml)")
